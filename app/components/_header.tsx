...
const Header = () => {
    ...
    return(
        <div className="shadow-xl shadow-zinc-800 backdrop-blur-sm bg-zinc-800/10 min-w-screen h-[8vh] 2xs:h-[10vh] xs:h-[10vh] md:h-[8vh] xl:h-[8vh] flex items-center font-mono fixed top-0 z-50 px-4">
            ...
            <span className="md:hidden text-lg font-semibold ml-4">ZINC</span>
