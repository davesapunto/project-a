...
export default function Profile(){
    ...
    return(
        <div className="bg-zinc-900 min-w-screen h-[100vh] font-mono flex flex-col items-center">
            <Header/>
            <div className="mt-20 w-[70%] h-[32.5%] flex items-center justify-center border-b-1">
                <Card className="flex justify-center bg-transparent w-[50vw] h-[80%] border border-neutral-400">
                    <CardContent className="w-full h-full flex justify-center ">
                        <div className="h-full w-[50%]  flex items-center justify-center gap-10">
                            <div className="border w-[30%] h-[72.5%] rounded-full">
            ...
            <div className="mt-11 w-[70%] h-[62.5%] flex flex-col gap-6">
                <h1 className="">
                    Review Diary
                </h1>
                {Array.from({length: 1}).map((_, index) => (
                    <div className="h-[25%] w-[60%] border border-dotted rounded-xl ml-auto mr-auto flex items-center justify-center" key={index}>
                        Placeholder
                    </div>
                ))}
            </div>
            ...
            {/* 
            div className="mt-11 min-w-screen h-[62.5%] flex flex-col gap-6">
